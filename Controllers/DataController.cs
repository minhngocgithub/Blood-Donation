            ...
            switch (dataType.ToLower())
            {
                case "donations":
                    ...
                    if (locationId.HasValue)
                        donations = donations.Where(d => d.Registration != null && d.Registration.Event.LocationId == locationId.Value);
            ...
            string exportPath)
        {
            ...
            switch (dataType.ToLower())
            {
                case "donations":
                    ...
                    if (locationId.HasValue) donations = donations.Where(d => d.Registration != null && d.Registration.Event.LocationId == locationId.Value);
