...
namespace Blood_Donation_Website.Controllers
{
    public class EventsController : Controller
    {
        ...
        public EventsController(IBloodDonationEventService eventService, IDonationRegistrationService registrationService, IDonationHistoryService donationHistoryService, IBloodTypeService bloodTypeService, ILocationService locationService)
        {
        ...
        public async Task<IActionResult> Index(string searchTerm, int? locationId, DateTime? fromDate, DateTime? toDate, string? bloodType)
        {
            try
            {
